...
description: 'Seja bem-vindo aos projetos do Dorneles! '
---
...
* [Guia de Contribuição](#guia-de-contribui%C3%A7%C3%A3o)
  * [1. Código de Conduta](#1-c%C3%B3digo-de-conduta)
  * [2. Antes de Começar](#2-antes-de-come%C3%A7ar)
  ...
  * [8. Estilo de Código e Automação](#8-estilo-de-c%C3%B3digo-e-automa%C3%A7%C3%A3o)
...
* **Husky:** Está configurado para rodar os testes e o linter em *pre-commit*. Não tente burlar (bypass) os hooks (`--no-verify`). Se o hook falhou, o código não está pronto.
